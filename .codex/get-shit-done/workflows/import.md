...
```bash
node "C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/get-shit-done/bin/gsd-tools.cjs" commit "docs({phase}): import plan from {basename FILEPATH}" --files .planning/phases/{phase}/{plan}-PLAN.md .planning/ROADMAP.md
```
