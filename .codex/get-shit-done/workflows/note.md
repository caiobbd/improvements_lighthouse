...
- **Global scope**: `C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/notes/`)
...
2. Glob `C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/notes/*.md` (if directory exists) — global notes
...
Global (C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/Users/CaioBorges/_pgms/_repos/improvements_lighthouse/.codex/notes/` — works in any directory
